...
export const WEAPONS: readonly WeaponDefinition[] = [
  ...
  { id: 'shotgun', label: '泵动霰弹枪', short: 'SHOTGUN', model: 'Shotgun', capacity: 6, interval: 0.64, reloadDuration: 0.55, shellReload: true, automatic: false, damage: 32, pellets: 7, spread: 0.036, length: 0.90, rotationY: 0, fireDuration: 0.60, recoil: 1.2, ads: [0, -.07, -.48] },
  ...
  { id: 'auto-shotgun', label: '自动霰弹枪', short: 'AUTO SG', model: 'AutoShotgun', capacity: 12, interval: .30, reloadDuration: 2.25, automatic: true, damage: 20, pellets: 8, spread: .05, length: .92, rotationY: 0, fireDuration: .25, recoil: 1.05, procedural: true, ads: [0, -.07, -.49] },
